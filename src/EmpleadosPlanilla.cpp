...
string EmpleadosPlanilla::menuEmpleadosPlanilla(string nombreUsuario)
{
	...
	cout<<"\t\t\t---------------------------------------"<<endl;
	cout<<"\t\t\t 1. Ingresar Datos de Clientes "<<endl;
	cout<<"\t\t\t 2. Buscar Clientes"<<endl;
	cout<<"\t\t\t 3. Modificar Datos de Clientes"<<endl;
	cout<<"\t\t\t 4. Eliminar Clientes"<<endl;
	cout<<"\t\t\t 5. Imprimir Datos de Clientes"<<endl;
   ...
   // enviarDatosE.ingresoDatosBitacora(userName,"7110","BUS");
	...
	else
	{
		...
		while(!file.eof())
		{
			...
			{
				cout<<"\n\n\t\t\t Id Cliente        : "<<idEmpleado<<endl;
                cout<<"\n\n\t\t\t Nombre Cliente    : "<<nombreEmpleado<<endl;
                cout<<"\t\t\t Apellido Cliente      : "<<apellidoEmpleado<<endl;
                cout<<"\t\t\t fecha de nacimiento        : "<<dpiEmpleado<<endl;
                cout<<"\t\t\t Genero     : "<<direccionEmpleado<<endl;
                cout<<"\t\t\t direccion Cliente      : "<<telefonoEmpleado<<endl;
				found++;
			}
			file >> idEmpleado >> nombreEmpleado >> apellidoEmpleado >> dpiEmpleado >> direccionEmpleado >> telefonoEmpleado;
		}
   ...
   fstream file;
	...
	else
	{
		...
		while(!file.eof())
		{
			total++;
			cout<<"\n\n\t\t\t Id Cliente           : "<<idEmpleado<<endl;
			cout<<"\t\t\t Nombre Cliente      : "<<nombreEmpleado<<endl;
			cout<<"\t\t\t Apellido Cliente    : "<<apellidoEmpleado<<endl;
			cout<<"\t\t\t Fecha de Nacimiento         : "<<dpiEmpleado<<endl;
			cout<<"\t\t\t Genero   : "<<direccionEmpleado<<endl;
